...
static const char *fonts[]          = { "Inconsolata for Powerline:pixelsize=16:antialias=true:autohint=true" };
static const char dmenufont[]       = "Inconsolata for Powerline:pixelsize=16:antialias=true:autohint=true";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_x,      spawn,          {.v = i3lock } },
